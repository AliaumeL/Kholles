...
On cherche les solutions $\mb{R} \rightarrow \mb{R}_+^*$ de $y' = \sin(t) y + \cos(t) \sqrt{y}$ $(B)$.

\begin{enumerate}

\item Montrer si $f$ est solution de $(B)$, alors $\sqrt{f}$ est solution de $2y' = \sin(t) y + \cos(t)$ $(E)$.
