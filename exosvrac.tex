...
\item On suppose que $\alpha^m -1$ est premier.  Montrer que $\alpha = 2$. En déduire que $m$ est premier.

\end{enumerate}

\item On note pour $p$ premier $M_p = 2^p -1$ (appelé nombre de Mersenne). Calculer $2^{11} [23]$. En déduire que $M_{11}$ n'est pas premier.
...
\item Soit $p$ un facteur premier de $M$.

\begin{enumerate}

\item Montrer que $p \not \equiv -1[6]$. \emph{On raisonnera par l'absurde.}

\item En déduire que $p \equiv 1[6]$.

\end{enumerate}

\item Conclure que $M \equiv 1 [6]$. En déduire une contradiction.
