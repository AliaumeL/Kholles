...
Résoudre l'équation $P \circ P = P$ d'inconnue $P \in \mb{R}[X]$.

\exercice

Soit $r$ le reste de la division euclidienne de $n$ par $k$. Monter que le reste de la division euclidienne de $X^n$ par $X^k - 1$ est $X^r$.
